...
# This randomly selects 250 genes to test for enrichment
set.seed(1)
# interesting_genes = sample(gene_universe, 250, replace = FALSE)
interesting_genes = rownames(clusterGenes)
...
# For cluster visualization (Optional)
BiocManager::install("Rgraphviz")
library(Rgraphviz)

g = showSigOfNodes(GO_bp_tester, score(result_fisher))
